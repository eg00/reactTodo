...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(133);
...
/* harmony import */ var components_Catcher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(136);
// Core
...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_Catcher__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_Scheduler__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null));
  }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Catcher; });
...
/* harmony import */ var _styles_m_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(137);
/* harmony import */ var _styles_m_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_styles_m_css__WEBPACK_IMPORTED_MODULE_2__);
...
class Catcher extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    super(...args);
  ...
  render() {
    if (this.state.error) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
        className: _styles_m_css__WEBPACK_IMPORTED_MODULE_2___default.a.catcher
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Error occured"));
    }
...
_defineProperty(Catcher, "propTypes", {
  children: prop_types__WEBPACK_IMPORTED_MODULE_1__["object"].isRequired
});
...
// extracted by mini-css-extract-plugin
module.exports = {"catcher":"styles-m__catcher---6cxTy"};
...
function Task_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class Task_Task extends react["PureComponent"] {
  constructor(props) {
    ...
    Task_defineProperty(this, "_getTaskShape", ({
      id = this.props.id,
    ...
    Task_defineProperty(this, "_setTaskEditingState", TaskEditingState => {
      this.setState({
    ...
    Task_defineProperty(this, "_updateNewTaskMessage", event => {
      const {
        value
      } = event.target;
      this.setState({
    ...
    Task_defineProperty(this, "_updateTaskMessageOnClick", () => {
      const {
        isTaskEditing
      } = this.state;
    ...
    Task_defineProperty(this, "_cancelUpdatingTaskMessage", () => {
      this.setState({
    ...
    Task_defineProperty(this, "_updateTaskMessageOnKeyDown", event => {
      const {
        newMessage
      } = this.state;
    ...
    Task_defineProperty(this, "_updateTask", () => {
      const {
        newMessage
      } = this.state;
      const {
    ...
    Task_defineProperty(this, "_toggleTaskCompletedState", () => {
      const {
        _updateTaskAsync,
        completed
      } = this.props;
    ...
    Task_defineProperty(this, "_toggleTaskFavoriteState", () => {
      const {
        _updateTaskAsync,
        favorite
      } = this.props;
    ...
    Task_defineProperty(this, "_removeTask", () => {
      const {
        _removeTaskAsync,
        id
      } = this.props;
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      className: styles_m_default.a.task
...
Task_defineProperty(Task_Task, "propTypes", {
  _removeTaskAsync: prop_types["func"].isRequired,
  _updateTaskAsync: prop_types["func"].isRequired,
  tasks: Object(prop_types["arrayOf"])(Object(prop_types["shape"])({
...
var Spinner_styles_m = __webpack_require__(135);
...
const api = {
  ...
  completeAllTasks: async tasks => {
    await tasks.map(task => fetch(MAIN_URL, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: TOKEN
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    Scheduler_defineProperty(this, "state", {
      tasks: [],
      isSpinning: false,
      newTaskMessage: "",
      tasksFilter: "",
    ...
    Scheduler_defineProperty(this, "_fetchTasksAsync", async () => {
    ...
    Scheduler_defineProperty(this, "_createTaskAsync", async event => {
      this._setTasksFetchingState(true);
    ...
    Scheduler_defineProperty(this, "_updateTaskAsync", async task => {
      this._setTasksFetchingState(true);
    ...
    Scheduler_defineProperty(this, "_removeTaskAsync", async id => {
      this._setTasksFetchingState(true);
    ...
    Scheduler_defineProperty(this, "_setTasksFetchingState", TasksFetchingState => {
      this.setState({
        isTasksFetching: TasksFetchingState
      });
    });

    Scheduler_defineProperty(this, "_updateNewTaskMessage", event => {
      const {
        value
      } = event.target;
      this.setState({
    ...
    Scheduler_defineProperty(this, "_updateTasksFilter", event => {
      const {
        value
      } = event.target;
      this.setState({
    ...
    Scheduler_defineProperty(this, "_completeAllTasksAsync", async () => {
    ...
    Scheduler_defineProperty(this, "_getAllCompleted", () => {
      const {
        tasks
      } = this.state;
  ...
  render() {
    ...
    const tasksJSX = sortTasksByGroup(tasks).filter(({
      message
    }) => message.includes(tasksFilter)).map(task => {
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.74afd.js.map